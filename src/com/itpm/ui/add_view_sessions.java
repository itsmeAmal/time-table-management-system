 ...
 * @author Anjula
 */
public class add_view_sessions extends javax.swing.JFrame {

    /**
     * Creates new form A
     */
    public add_view_sessions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Select Lectures & Tag", jTabbedPane2);
        jTabbedPane1.addTab("Select Group & Subject", jTabbedPane3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_view_sessions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_view_sessions().setVisible(true);
            }
        });
    }
