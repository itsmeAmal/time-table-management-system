...
public class Subject {
    ...
    public int getOfferedSemester() {return offeredSemester;}

    public void setOfferedSemester(int offeredSemester) {this.offeredSemester = offeredSemester;}
    ...
    public int getEvaluationHours() {return evaluationHours;}

    public void setEvaluationHours(int evaluationHours) {this.evaluationHours = evaluationHours;}
